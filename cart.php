...
<body>
  ...
  <div class="title mb-4">
    <h3>Hi <?php echo isset($user['firstName']) && isset($user['lastName']) ? $user['firstName'] . " " . $user['lastName'] : 'Guest'; ?>, Here's your cart!</h3>
  </div>
    ...
    <div class="order-summary">
      ...
      <div class="summary-details payment">
        ...
        <div>
          ...
          <label for="Takeaway">Online Payment</label>
        </div>
        <div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function updateSummary() {
        ...
        // Disable checkout button if total is 0 or no items selected
        const checkoutButton = document.getElementById('checkout-button');
        const totalAmount = subtotal + deliveryFee;
        const hasSelectedItems = document.querySelectorAll('input[type="checkbox"].form-check-input:checked').length > 0;
        
        if (totalAmount === 0 || !hasSelectedItems) {
      ...
      if (document.querySelectorAll('input[type="checkbox"].form-check-input').length === 0) {
        const checkoutButton = document.getElementById('checkout-button');
        checkoutButton.disabled = true;
        checkoutButton.style.opacity = '0.6';
        checkoutButton.style.cursor = 'not-allowed';
